...
function getDefaultState() {
  ...
  return {
    users: {
      // --- GF bay owners ---
      u1:  { id: 'u1',  phone: '+447700900001', email: 'tomek@onespot.demo', name: 'Tomek',    is_owner: true, level: 'G', bay_number: '7',  credits: 20, availability_permission: 'anyone' },
      u2:  { id: 'u2',  phone: '+447700900002', email: 'sarah@onespot.demo', name: 'Sarah',    is_owner: true, level: 'G', bay_number: '12', credits: 20, availability_permission: 'anyone' },
      u3:  { id: 'u3',  phone: '+447700900003', email: 'mike@onespot.demo', name: 'Mike',     is_owner: true, level: 'G', bay_number: '23', credits: 20, availability_permission: 'anyone' },
      u5:  { id: 'u5',  phone: '+447700900005', email: 'priya@onespot.demo', name: 'Priya',    is_owner: true, level: 'G', bay_number: '3',  credits: 15, availability_permission: 'anyone' },
      u6:  { id: 'u6',  phone: '+447700900006', email: 'alex@onespot.demo', name: 'Alex',     is_owner: true, level: 'G', bay_number: '10', credits: 22, availability_permission: 'anyone' },
      u7:  { id: 'u7',  phone: '+447700900007', email: 'wei@onespot.demo', name: 'Wei',      is_owner: true, level: 'G', bay_number: '16', credits: 18, availability_permission: 'anyone' },
      u8:  { id: 'u8',  phone: '+447700900008', email: 'fatima@onespot.demo', name: 'Fatima',   is_owner: true, level: 'G', bay_number: '20', credits: 25, availability_permission: 'anyone' },
      u9:  { id: 'u9',  phone: '+447700900009', email: 'dan@onespot.demo', name: 'Dan',      is_owner: true, level: 'G', bay_number: '28', credits: 12, availability_permission: 'anyone' },
      u10: { id: 'u10', phone: '+447700900010', email: 'lena@onespot.demo', name: 'Lena',     is_owner: true, level: 'G', bay_number: '35', credits: 20, availability_permission: 'anyone' },
      u11: { id: 'u11', phone: '+447700900011', email: 'raj@onespot.demo', name: 'Raj',      is_owner: true, level: 'G', bay_number: '40', credits: 16, availability_permission: 'anyone' },
      u12: { id: 'u12', phone: '+447700900012', email: 'emma@onespot.demo', name: 'Emma',     is_owner: true, level: 'G', bay_number: '45', credits: 20, availability_permission: 'anyone' },
      u13: { id: 'u13', phone: '+447700900013', email: 'ollie@onespot.demo', name: 'Ollie',    is_owner: true, level: 'G', bay_number: '5',  credits: 14, availability_permission: 'anyone' },
      u14: { id: 'u14', phone: '+447700900014', email: 'yuki@onespot.demo', name: 'Yuki',     is_owner: true, level: 'G', bay_number: '31', credits: 20, availability_permission: 'anyone' },
      u15: { id: 'u15', phone: '+447700900015', email: 'carlos@onespot.demo', name: 'Carlos',   is_owner: true, level: 'G', bay_number: '38', credits: 18, availability_permission: 'anyone' },
      // --- MZ bay owners ---
      u16: { id: 'u16', phone: '+447700900016', email: 'anya@onespot.demo', name: 'Anya',     is_owner: true, level: 'M', bay_number: '5',  credits: 20, availability_permission: 'anyone' },
      u17: { id: 'u17', phone: '+447700900017', email: 'ben@onespot.demo', name: 'Ben',      is_owner: true, level: 'M', bay_number: '15', credits: 22, availability_permission: 'anyone' },
      u18: { id: 'u18', phone: '+447700900018', email: 'chloe@onespot.demo', name: 'Chloe',    is_owner: true, level: 'M', bay_number: '25', credits: 18, availability_permission: 'anyone' },
      u19: { id: 'u19', phone: '+447700900019', email: 'david@onespot.demo', name: 'David',    is_owner: true, level: 'M', bay_number: '36', credits: 20, availability_permission: 'anyone' },
      u20: { id: 'u20', phone: '+447700900020', email: 'elena@onespot.demo', name: 'Elena',    is_owner: true, level: 'M', bay_number: '42', credits: 15, availability_permission: 'anyone' },
      u21: { id: 'u21', phone: '+447700900021', email: 'finn@onespot.demo', name: 'Finn',     is_owner: true, level: 'M', bay_number: '50', credits: 20, availability_permission: 'anyone' },
      u22: { id: 'u22', phone: '+447700900022', email: 'grace@onespot.demo', name: 'Grace',    is_owner: true, level: 'M', bay_number: '60', credits: 25, availability_permission: 'anyone' },
      u23: { id: 'u23', phone: '+447700900023', email: 'hugo@onespot.demo', name: 'Hugo',     is_owner: true, level: 'M', bay_number: '70', credits: 20, availability_permission: 'anyone' },
      u24: { id: 'u24', phone: '+447700900024', email: 'isla@onespot.demo', name: 'Isla',     is_owner: true, level: 'M', bay_number: '80', credits: 17, availability_permission: 'anyone' },
      u25: { id: 'u25', phone: '+447700900025', email: 'james@onespot.demo', name: 'James',    is_owner: true, level: 'M', bay_number: '90', credits: 20, availability_permission: 'anyone' },
      u26: { id: 'u26', phone: '+447700900026', email: 'karen@onespot.demo', name: 'Karen',    is_owner: true, level: 'M', bay_number: '55', credits: 22, availability_permission: 'anyone' },
      u27: { id: 'u27', phone: '+447700900027', email: 'liam@onespot.demo', name: 'Liam',     is_owner: true, level: 'M', bay_number: '67', credits: 20, availability_permission: 'anyone' },
      u28: { id: 'u28', phone: '+447700900028', email: 'mia@onespot.demo', name: 'Mia',      is_owner: true, level: 'M', bay_number: '78', credits: 18, availability_permission: 'anyone' },
      u29: { id: 'u29', phone: '+447700900029', email: 'noah@onespot.demo', name: 'Noah',     is_owner: true, level: 'M', bay_number: '85', credits: 20, availability_permission: 'anyone' },
      u30: { id: 'u30', phone: '+447700900030', email: 'olivia@onespot.demo', name: 'Olivia',   is_owner: true, level: 'M', bay_number: '94', credits: 16, availability_permission: 'anyone' },
      // --- Demo user (bay owner) + non-owners ---
      u4:  { id: 'u4',  phone: '+447700900004', email: 'jane@onespot.demo', name: 'Jane',     is_owner: true, level: 'M', bay_number: '48', credits: 16, availability_permission: 'anyone' },
      u31: { id: 'u31', phone: '+447700900031', email: 'ravi@onespot.demo', name: 'Ravi',     is_owner: false, level: null, bay_number: null, credits: 20, availability_permission: 'anyone' },
      u32: { id: 'u32', phone: '+447700900032', email: 'sophie@onespot.demo', name: 'Sophie',   is_owner: false, level: null, bay_number: null, credits: 14, availability_permission: 'anyone' },
      u33: { id: 'u33', phone: '+447700900033', email: 'tom@onespot.demo', name: 'Tom',      is_owner: false, level: null, bay_number: null, credits: 10, availability_permission: 'anyone' },
      u34: { id: 'u34', phone: '+447700900034', email: 'uma@onespot.demo', name: 'Uma',      is_owner: false, level: null, bay_number: null, credits: 20, availability_permission: 'anyone' },
    },
    availabilities: {
      // GF owners
      ...
      // Jane (demo user)
      a4:  { id: 'a4',  user_id: 'u4',  type: 'recurring', paused: false, exclusions: [], pattern: officeHours },
      // MZ owners
